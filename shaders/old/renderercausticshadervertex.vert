...
varying vec3 oldPos;
varying vec3 newPos;
varying vec3 ray;        /* project the ray onto the plane */    
...
void main() {
    ...
    info.ba *= 0.5;
    vec3 normal = vec3(info.b, sqrt(1.0 - dot(info.ba, info.ba)), info.a);            /* project the vertices along the refracted vertex ray */      
